"""EMA crossover strategy (Milestone 3 implementation).

This class owns the new evaluation path. The historical productive
``EmaCrossoverStrategy`` remains registered and unchanged.
"""
